...
import static com.yeepay.message.TxnPropNames.BILLS_REC_NO;
 ...
 *
 */
public class Field48LifePaymentTransferHelper implements Iso8583FieldTransferHelper {
	...
	public boolean setFieldInfo(ISOMsg isoMsg, TxnContext txnCtx, Iso8583BitMap iso8583BitMap) throws AppBizException {
		String value = "1";
		if(txnCtx.getStringProperty(BILLS_REC_NO) != null){
			...
			String powerBillsRecNo = txnCtx.getStringProperty(BILLS_REC_NO);//应收电费、水费标识号
