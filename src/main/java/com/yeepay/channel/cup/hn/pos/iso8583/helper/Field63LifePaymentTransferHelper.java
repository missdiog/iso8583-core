...
import static com.yeepay.message.TxnPropNames.UNIT_CODE;
 ...
 **/
public class Field63LifePaymentTransferHelper implements Iso8583FieldTransferHelper {
	...
	public boolean getFieldInfo(ISOMsg isoMsg, TxnContext txnCtx, Iso8583BitMap iso8583BitMap) throws AppBizException {
		...
		txnCtx.setProperty(UNIT_CODE, unitCode);
	...
	public boolean setFieldInfo(ISOMsg isoMsg, TxnContext txnCtx, Iso8583BitMap iso8583BitMap) throws AppBizException {
		return Iso8583Operator.setField(isoMsg, getFieldNo(), txnCtx.getStringProperty(UNIT_CODE));
	}
