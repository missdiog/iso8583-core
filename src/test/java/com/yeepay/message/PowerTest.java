...
public class PowerTest {
	...
	public static void main(String[] args) throws Exception {
		...
		ctx.setProperty(AUTH_AMT, new BigDecimal("100"));//交易金额
		ctx.setProperty(AUTH_TRACE_NO, "1234");//系统跟踪号
		ctx.setProperty(AUTH_TIME, new Date());//交易日期/时间
		...
		ctx.setProperty(UNIT_CODE, "666666");//供电单位编码
